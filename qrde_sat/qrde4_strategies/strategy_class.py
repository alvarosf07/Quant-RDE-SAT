...
# Class Imports from Backtesting Libraries:
from backtesting.backtesting import Strategy as Strategy_btpy
from backtesting.backtesting import _Orders
...
#from ..qrde5_backtesting.bt1_engine.backtesting_engine import Order, Trade, Position


class Strategy(BaseModel,Portfolio,Strategy_btpy):

    '''
    A trading strategy base class. Actionable decisions on a Portfolio object.
