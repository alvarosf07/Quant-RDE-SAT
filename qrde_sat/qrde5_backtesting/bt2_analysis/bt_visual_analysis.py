...
from bokeh.models import (CrosshairTool,CustomJS,ColumnDataSource,NumeralTickFormatter,Span,HoverTool,Range1d,DatetimeTickFormatter,WheelZoomTool,LinearColorMapper)
...
class Plotting(Backtest):
    """
    Extends class Backtest to add plotting and visual analysis tools
    """
